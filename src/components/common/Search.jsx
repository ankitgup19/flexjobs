...
import {
  ...
  Styledform,
  Select,
} from "../../../styles/components/common/Search.styles";
...
const Search = (props) => {
  ...
  useEffect(() => {
    isMobile &&
      (setSearchPh("Search for Jobs...") || setLocationPh("Location"));
  });
    ...
    <Styledform action="/search" method="get">
      <SearchWrap className={props.type}>
        <InputSearch
          ...
          onChange={(e) => setJtText(e.target.value)}
          value={jtText}
        ...
        <SearchBtn type="submit" className="submit-btn">
