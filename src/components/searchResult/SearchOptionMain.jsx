...
const REMOTE_LIST = [
  { value: 'Remote - Any Level', label: 'Remote - Any Level' },
  { value: '100% Remote Work', label: '100% Remote Work' },
  { value: 'Hybrid Remote Work', label: 'Hybrid Remote Work' },
  { value: 'Option for Remote Work', label: 'Option for Remote Work' },
  { value: 'No Remote Work', label: 'No Remote Work' },
];
...
const WORK_SCHEDULE_LIST = [
  ...
  { value: 'Alternative Schedule', label: 'Alternative Schedule' },
];
const CAREER_LEVEL_LIST = [
  { value: 'Entry-Level', label: 'Entry-Level' },
  { value: 'Experienced', label: 'Experienced' },
  { value: 'Manager', label: 'Manager' },
  { value: 'Senior Level Manager', label: 'Senior Level Manager' },
];
...
const TRAVEL_LIST = [
  ...
  { value: 'Yes, a bit', label: 'Yes, a bit' },
  { value: 'No', label: 'No' },
  { value: 'No specification', label: 'No specification' },
];
          ...
          <div className='form-group'>
            ...
            <div className='controls'>
              <ReactSelect
                options={REMOTE_LIST}
                isMulti
                className="rct-slct-wrp"
                classNamePrefix="rct-slct"
                placeholder='Select'
                isClearable={false}
                components={{
...
const SearchOptionMainWrap = styled.div`
  ...
  .rct-slct__multi-value {
    background: ${props => props.theme.colors.primaryLight};
    border-radius: .4rem;
  }
  .rct-slct__multi-value__label {
    color: ${props => props.theme.colors.white}; 
  }
  .rct-slct__multi-value__remove {
    color: ${props => props.theme.colors.white};
    cursor: pointer;
    &:hover {
  ...
  .rct-slct__control:hover,
  .rct-slct__control--is-focused {
    box-shadow: none;
    border-color: ${props => props.theme.colors.tertiartyMedium};
  }
  .row {
    display: flex;
    flex-wrap: wrap;
